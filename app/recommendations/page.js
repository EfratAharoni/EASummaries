...
const MANUAL_RECOMMENDATIONS = [
  {
    aliases: ["אנגלית"],
    tips: [
      "בעיני כל הרמות, מבסיסי עד מתקדמים, הן אותו הדבר.",
      "אז אם קשה לכם בבסיסי אל תלחצו, בסוף כולם עוברים את זה.",
      "בלי קשר מומלץ ממש לשפר את האנגלית ולהרחיב את אוצר המילים.",
    ],
  },
  {
    aliases: ["סטטיסטיקה"],
