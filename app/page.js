...
const SITE_FEATURES = [
  ...
  },
  {
    ...
    accent: "#c0584a",
    title: "הקלטות",
    desc: "לכל קורס - האם כדאי לנכוח בשיעורים או שאפשר להסתמך על הקלטות, מתוך ניסיון אישי.",
  },
  {
    href: "/electives",
    icon: "05",
        ...
        <article className="landing-story">
          ...
          <div className="landing-story-text">
            <p>
              ...
              בתכנות.
              <br />
              מהר מאוד גיליתי שהמעבר מהתיכון לאקדמיה הוא מאתגר הרבה יותר ממה
              שדמיינתי.
              <br />
              בתיכון הייתי תלמידה מצטיינת והייתי בטוחה שהכול יהיה בשליטה, אבל
              כבר בסמסטר הראשון הבנתי שזה עולם אחר לגמרי.
            </p>
            <p>
